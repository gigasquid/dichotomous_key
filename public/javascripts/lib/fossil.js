(function() {
  window.specimens = {
    ...
    GASTROPOD: {
      name: "GASTROPOD",
      photo_image: ["Gastropod1.jpg", "Gastropod2.jpg"],
      drawing_image: ["Gastropod_anat_1.jpg", "Gastropod_anat_2.jpg"],
      description: "Gastropod or, 'stomach foot' was the ancestor to the modern snail. After insects, snails  have the highest number of different species among all animals. Since the early Cambrian period, they have slowly but continuously increased in variety and importance up to present day. Certain forms have adapted to terrestrial life, but must are aquatic.",
  ...
  window.fossils_data = [
    {
      ...
      key_pair: 3,
      statement: "The fossil is 'bug shaped', ribbed with three sections, lip and eyes.",
      help_image: "3b_bug_shape_2.gif",
      specimen: specimens.TRILOBYTE
    }, {
      key_pair: 4,
      ...
      help_image: "6a_thin_pencil.png",
      specimen: specimens.CRINOID
    }, {
      key_pair: 6,
